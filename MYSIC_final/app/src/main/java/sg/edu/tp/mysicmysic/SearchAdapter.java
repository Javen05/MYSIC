...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> implements Filterable {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if(charString.isEmpty()) {
                    ...
                    for(int i = 0; i < originalSonglist.size(); i++) {
                        ...
                        if(originalSonglist.get(i).getTitle().toLowerCase().contains(charString.toLowerCase())) {

                            filteredList.add(originalSonglist.get(i));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView, RecyclerViewInterface recyclerViewInterface) {
            ...
            imageSongs = itemView.findViewById(R.id.imageView);
