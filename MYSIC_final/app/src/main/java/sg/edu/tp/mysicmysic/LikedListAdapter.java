...
public class LikedListAdapter extends RecyclerView.Adapter<PlaylistAdapter.MyViewHolder>  {
    ...
    public LikedListAdapter(Context context, ArrayList<Song> Songlist,
